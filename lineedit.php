...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <?php
              $sqledit = "SELECT * FROM [dbo].[linenoti] WHERE [no] = '".$_GET['no']."' ";
    ...
    <script type="text/javascript">
      ...
      function fncAction2()
      {
        if (line_name.value.length == 0){ 
            ...
            document.addRow.action='editline?no=<?php echo $resultedit['no']; ?>';
    ...
    <section class="content">
      <form action="editline?no=<?php echo $resultedit['no']; ?>" method="POST" name="addRow">
          ...
          <div class="col-md">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Edit Line Notification</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="exampleInputBorder">Enable</label>
                        <div class="card-body">
                        <input value="<?php echo $resultedit['Enable']; ?>" type="checkbox" name="line_enable" data-on-text="Enable" data-off-text="Disable" data-bootstrap-switch data-off-color="danger" data-on-color="success" <?php if (strpos($resultedit['Enable'],'x') !== false) echo 'checked="checked" value="x"'; ?>>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border" id="line_name" name="line_name" value="<?php echo $resultedit['Dashboardname']; ?>" autocomplete=off readonly>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border" id="line_token" name="line_token" value="<?php echo $resultedit['Token']; ?>" autocomplete=off>
                      </div>
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border" id="line_filtername" name="line_filtername" value="<?php echo $resultedit['FilterName']; ?>" autocomplete=off>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputBorder">filterValue</label>
                        <input type="text" class="form-control form-control-border" id="line_filtervalue" name="line_filtervalue" value="<?php echo $resultedit['FilterValue']; ?>" autocomplete=off>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <!--- somewhere within <body> -->
                          ...
                          <input class="example7-input form-control form-control-border" id="line_corn" name="line_corn" value="<?php echo $resultedit['Time']; ?>" autocomplete=off readonly/>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-border" id="line_message" name="line_message" value="<?php echo $resultedit['Message']; ?>" autocomplete=off>
                      </div>
